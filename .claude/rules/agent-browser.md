...
> **Playwright MCP が最優先。agent-browser は第2選択肢として使用**
> Chrome for Claude (mcp__claude-in-chrome__*) は使用禁止

| ツール | 優先度 | 用途 |
|--------|--------|------|
| **Playwright CLI** | ⭐⭐⭐⭐⭐ 最優先 | bunx playwright / npx playwright |
| **Playwright MCP** | ⭐⭐⭐⭐ 第2選択 | CLIが使えない場合 |
| **agent-browser (ab)** | ⭐⭐⭐ 第3選択 | Playwright非対応時、スクレイピング |
| Chrome for Claude | ❌ 使用禁止 | 無効化済み |
